...
<html>
	...
	<a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
		...
		<div class="twitter"><a href="https://twitter.com/share" class="twitter-share-button" data-size="large" data-show-count="false">Tweet</a><script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script></div> <!--twitter-->
	...
	<?php
		...
		if ($numberRow > 0){
			while($row = mysql_fetch_assoc($res)){
			        echo "<div id = 'content'><div id='date'>".$row["date"]."<br><div id='delete'><a href='delete.php?id=". $row["id"]."'>Delete</a></div></div><div id='title'>". $row["title"]."</div><div id='main'>".$row["main"]."</div><hr></div>";
			} //while	
		} //if
		else {
